...
const Search = () => {
  ...
  return (
    <StyledSearch>
      ...
      <Drawer anchor={"top"} open={open} onClose={closeAndReset}>
        <StyledDrawerContent>
          ...
          {!isFetching && searchResult && (
            <Paper variant="outlined" className="search-results">
              <TrackList hideHeader={true} cover="" tracks={searchResult.data} />
            </Paper>
          )}
        </StyledDrawerContent>
      </Drawer>
